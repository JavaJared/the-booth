...
export const OFFENSE = [
  ...
  { id: 'iz', name: 'Inside Zone', family: 'run', pers: '11', tag: 'Base run',
    success: 0.515, mean: 5.217, sd: 3.4, stuff: 0.14, fumble: 0.008, edge: 'inside', boxFit: 1.0 , targets: { RB1: 7, RB2: 3 } },
  { id: 'oz', name: 'Outside Zone', family: 'run', pers: '12', tag: 'Stretch',
    success: 0.4944, mean: 5.542, sd: 4.4, stuff: 0.18, fumble: 0.008, edge: 'outside', boxFit: 0.85 , targets: { RB1: 7, RB2: 3 } },
  { id: 'power', name: 'Power O', family: 'run', pers: '21', tag: 'Downhill',
    success: 0.5562, mean: 4.89, sd: 2.9, stuff: 0.12, fumble: 0.007, edge: 'inside', boxFit: 1.25 , targets: { RB1: 8, RB2: 2 } },
  { id: 'counter', name: 'Counter Trey', family: 'run', pers: '12', tag: 'Misdirection',
    success: 0.5047, mean: 5.869, sd: 4.6, stuff: 0.17, fumble: 0.009, edge: 'inside', boxFit: 0.75 , targets: { RB1: 7, RB2: 3 } },
  { id: 'toss', name: 'Toss Sweep', family: 'run', pers: '11', tag: 'Perimeter',
    success: 0.4635, mean: 5.977, sd: 5.2, stuff: 0.22, fumble: 0.010, edge: 'outside', boxFit: 0.70 , targets: { RB1: 6, RB2: 4 } },
  { id: 'draw', name: 'QB Draw', family: 'run', pers: '10', tag: 'Beats pressure',
    success: 0.4841, mean: 5.977, sd: 4.8, stuff: 0.19, fumble: 0.010, edge: 'inside', boxFit: 0.45 , targets: { QB: 10 } },
  { id: 'trap', name: 'Trap', family: 'run', pers: '11', tag: 'Beats penetration',
    success: 0.5253, mean: 5.325, sd: 3.9, stuff: 0.15, fumble: 0.008, edge: 'inside', boxFit: 0.65 , targets: { RB1: 7, RB2: 3 } },
  { id: 'sneak', name: 'QB Sneak', family: 'run', pers: 'heavy', tag: 'Short yardage',
    success: 0.8034, mean: 1.739, sd: 1.1, stuff: 0.08, fumble: 0.006, edge: 'inside', boxFit: 1.6 , targets: { QB: 10 } },
